...
define dso_local i32 @multiply(i32 %dummy2, i32 noundef %0, i32 %dummy1, i32 %dummy0, i32 noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @pack_color(i32 noundef %0, i32 %dummy0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @build_record(i32 noundef %0, i64 noundef %1, i8 noundef signext %2, double noundef %3, i32 %dummy0) #0 {
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @negate(i32 %dummy1, i32 %dummy0, i32 %dummy3, i32 %dummy2, i32 noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @constant_answer(i32 %dummy0, i32 %dummy2, i32 %dummy4, i32 %dummy3, i32 %dummy1) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @factorial(i32 %dummy0, i32 %dummy1, i32 %dummy2, i32 noundef %0, i32 %dummy3) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
11:                                               ; preds = %1
  ...
  %14 = sub nsw i32 %13, 1
  %15 = call i32 @factorial(i32 0, i32 0, i32 0, i32 %14, i32 0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @sub(i32 %dummy0, i32 %dummy2, i32 %dummy1, i32 noundef %0, i32 noundef %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #0 {
  ...
  %3 = call i32 @multiply(i32 0, i32 6, i32 0, i32 0, i32 7)
  %4 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3)
  %5 = call i32 @pack_color(i32 187, i32 0, i32 221, i32 170, i32 204)
  %6 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
  %7 = call i64 @build_record(i32 7, i64 1000, i8 65, double 1.500000e+00, i32 0)
  %8 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %7)
  %9 = call i32 @negate(i32 0, i32 0, i32 0, i32 0, i32 9)
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %9)
  %11 = call i32 @constant_answer(i32 0, i32 0, i32 0, i32 0, i32 0)
  %12 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %11)
  %13 = call i32 @factorial(i32 0, i32 0, i32 0, i32 5, i32 0)
  ...
  %17 = call i32 @sub(i32 0, i32 0, i32 0, i32 5, i32 3)
  %18 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, i32 noundef %17)
  %19 = call i32 @sub(i32 0, i32 0, i32 0, i32 3, i32 5)
