...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_f8F5CAE3EEC1FCD41(i32 noundef %0, i32 noundef %1) #0 {
...
define dso_local i32 @main() #0 {
  ...
  %3 = call i32 @_f69BD862F9C6ABBF5(i32 noundef 6, i32 noundef 7)
  %4 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3)
  %5 = call i32 @_fAD1F15246AF46C2(i32 noundef 170, i32 noundef 187, i32 noundef 204, i32 noundef 221)
  %6 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
  %7 = call i64 @_fE3D0F16670BA0BE8(i32 noundef 7, double noundef 1.500000e+00, i8 noundef signext 65, i64 noundef 1000)
  %8 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %7)
  %9 = call i32 @_f8861D07D75508871(i32 noundef 9)
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %9)
  %11 = call i32 @_fB5CF40918AE80198()
  %12 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %11)
  %13 = call i32 @_f2527BF8B46247DF8(i32 noundef 5)
  ...
  %17 = call i32 @_f8F5CAE3EEC1FCD41(i32 noundef 5, i32 noundef 3)
  %18 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, i32 noundef %17)
  %19 = call i32 @_f8F5CAE3EEC1FCD41(i32 noundef 3, i32 noundef 5)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_f69BD862F9C6ABBF5(i32 noundef %0, i32 noundef %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, ptr %3, align 4
  store i32 %1, ptr %4, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_fAD1F15246AF46C2(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @_fE3D0F16670BA0BE8(i32 noundef %0, double noundef %1, i8 noundef signext %2, i64 noundef %3) #0 {
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_f8861D07D75508871(i32 noundef %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, ptr %2, align 4
  %3 = load i32, ptr %2, align 4
  %4 = sub nsw i32 0, %3
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_fB5CF40918AE80198() #0 {
  ret i32 42
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_f2527BF8B46247DF8(i32 noundef %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, ptr %3, align 4
...
7:                                                ; preds = %1
  ...
  %10 = sub nsw i32 %9, 1
  %11 = call i32 @_f2527BF8B46247DF8(i32 noundef %10)
  %12 = mul nsw i32 %8, %11
