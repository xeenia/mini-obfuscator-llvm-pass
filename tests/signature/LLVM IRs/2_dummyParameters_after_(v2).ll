...
define dso_local i32 @multiply(i32 noundef %0, i32 noundef %1, i32 %dummy0, i32 %dummy1, i32 %dummy2) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @pack_color(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 %dummy0) #0 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @build_record(i32 noundef %0, double noundef %1, i8 noundef signext %2, i64 noundef %3, i32 %dummy0) #0 {
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @negate(i32 noundef %0, i32 %dummy0, i32 %dummy1, i32 %dummy2, i32 %dummy3) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @constant_answer(i32 %dummy0, i32 %dummy1, i32 %dummy2, i32 %dummy3, i32 %dummy4) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @factorial(i32 noundef %0, i32 %dummy0, i32 %dummy1, i32 %dummy2, i32 %dummy3) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
11:                                               ; preds = %1
  ...
  %14 = sub nsw i32 %13, 1
  %15 = call i32 @factorial(i32 %14, i32 0, i32 0, i32 0, i32 0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @sub(i32 noundef %0, i32 noundef %1, i32 %dummy0, i32 %dummy1, i32 %dummy2) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #0 {
  ...
  %3 = call i32 @multiply(i32 6, i32 7, i32 0, i32 0, i32 0)
  %4 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3)
  %5 = call i32 @pack_color(i32 170, i32 187, i32 204, i32 221, i32 0)
  %6 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
  %7 = call i64 @build_record(i32 7, double 1.500000e+00, i8 65, i64 1000, i32 0)
  %8 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %7)
  %9 = call i32 @negate(i32 9, i32 0, i32 0, i32 0, i32 0)
  ...
  %13 = call i32 @factorial(i32 5, i32 0, i32 0, i32 0, i32 0)
  ...
  %17 = call i32 @sub(i32 5, i32 3, i32 0, i32 0, i32 0)
  %18 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, i32 noundef %17)
  %19 = call i32 @sub(i32 3, i32 5, i32 0, i32 0, i32 0)
