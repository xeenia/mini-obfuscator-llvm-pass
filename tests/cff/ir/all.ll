...
entry:
  ...
  %cff.b = load i32, ptr %b, align 4
  %cff = load i32, ptr %2, align 4
  %cff2 = add i32 %cff, 153
  %cff3 = sub i32 %cff2, %cff
  %cff4 = sub i32 %cff.b, 153
  %cff5 = add i32 %cff3, %cff4
  br label %switch
...
switch:                                           ; preds = %entry, %break
  %arg1 = load i32, ptr %2, align 4
  %15 = and i32 %arg1, 1
  %cff6 = icmp eq i32 %15, 0
  %cff7 = select i1 %cff6, i32 1, i32 0
  %cff8 = add i32 163, %cff7
  %cff9 = xor i32 %cff5, %cff8
  %cff10 = mul i32 %cff9, 87
  switch i32 %cff10, label %default [
    i32 291, label %3
    i32 288, label %4
    i32 297, label %7
    i32 294, label %10
