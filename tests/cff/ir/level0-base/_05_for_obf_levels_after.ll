...
loop:                                             ; preds = %35, %32, %31, %27, %22, %17, %12, %11, %10, %6, %5
  br label %switch
}
...
loop:                                             ; preds = %41, %38, %25, %20, %18, %17, %13, %9, %8
  br label %switch
}
...
loop:                                             ; preds = %12, %11, %10, %9, %8, %7, %6, %case3, %case2, %case1, %case
  br label %switch
...
loop:                                             ; preds = %41, %40, %37, %29, %28, %24, %19, %18, %17, %13, %8, %7
  br label %switch
}
...
loop:                                             ; preds = %52, %49, %46, %case2, %case1, %case, %42, %36, %33, %28, %24, %19, %14, %13
  br label %switch
...
24:                                               ; preds = %switch
  ...
  %25 = select i1 %.reload, i32 1, i32 5
...
loop:                                             ; preds = %59, %56, %51, %40, %34, %30, %16
  br label %switch
}
...
loop:                                             ; preds = %62, %58, %57, %56, %50, %46, %45, %42, %34, %30, %29, %case2, %case1, %case
  br label %switch
